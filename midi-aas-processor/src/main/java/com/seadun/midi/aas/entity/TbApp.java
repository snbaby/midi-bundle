 ...
 */
@Table(name = "tb_app")
public class TbApp extends ActiveRecord<TbApp> {
	/**应用编码*/
	@Id
	private String code;
	/**应用名称*/
	...
	public String toString() {
		return "TbApp [code=" + code + " , name=" + name + " , description=" + description + " , crtCode=" + crtCode + " , crtTime=" + crtTime + " , uptCode=" + uptCode + " , uptTime=" + uptTime + "  ]";
